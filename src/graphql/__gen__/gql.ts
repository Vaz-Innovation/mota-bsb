 ...
 */
type Documents = {
    "\n  fragment AuthorCard on User {\n    id\n    databaseId\n    name\n    slug\n    email\n    description\n    avatar {\n      url\n    }\n  }\n": typeof types.AuthorCardFragmentDoc,
    "\n  fragment AuthorPostCard on Post {\n    id\n    title\n    slug\n    date\n    excerpt\n    featuredImage {\n      node {\n        sourceUrl\n        altText\n      }\n    }\n    categories {\n      nodes {\n        id\n        name\n        slug\n      }\n    }\n  }\n": typeof types.AuthorPostCardFragmentDoc,
...
const documents: Documents = {
    "\n  fragment AuthorCard on User {\n    id\n    databaseId\n    name\n    slug\n    email\n    description\n    avatar {\n      url\n    }\n  }\n": types.AuthorCardFragmentDoc,
    "\n  fragment AuthorPostCard on Post {\n    id\n    title\n    slug\n    date\n    excerpt\n    featuredImage {\n      node {\n        sourceUrl\n        altText\n      }\n    }\n    categories {\n      nodes {\n        id\n        name\n        slug\n      }\n    }\n  }\n": types.AuthorPostCardFragmentDoc,
 ...
 */
export function graphql(source: "\n  fragment AuthorCard on User {\n    id\n    databaseId\n    name\n    slug\n    email\n    description\n    avatar {\n      url\n    }\n  }\n"): typeof import('./graphql').AuthorCardFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment AuthorPostCard on Post {\n    id\n    title\n    slug\n    date\n    excerpt\n    featuredImage {\n      node {\n        sourceUrl\n        altText\n      }\n    }\n    categories {\n      nodes {\n        id\n        name\n        slug\n      }\n    }\n  }\n"): typeof import('./graphql').AuthorPostCardFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query AuthorBySlug($slug: ID!, $first: Int = 100, $language: LanguageCodeFilterEnum!) {\n    user(id: $slug, idType: SLUG) {\n      ...AuthorCard\n      posts(first: $first, where: { orderby: { field: DATE, order: DESC } }) {\n        nodes {\n          ...AuthorPostCard\n          language {\n            code\n          }\n        }\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n      }\n    }\n    categories(first: 100, where: { language: $language }) {\n      nodes {\n        id\n        name\n        slug\n        count\n      }\n    }\n  }\n"): typeof import('./graphql').AuthorBySlugDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query AuthorSlugs($first: Int = 100) {\n    users(first: $first) {\n      nodes {\n        slug\n      }\n    }\n  }\n"): typeof import('./graphql').AuthorSlugsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
