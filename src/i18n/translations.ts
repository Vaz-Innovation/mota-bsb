...
export const translations: Translations = {
  ...
  ES: {
    ...
    "about.trajectory.full": "Con más de dos décadas de actuación en el mercado jurídico, la firma Mota & Advogados Associados ha construido una trayectoria sólida basada en resultados consistentes y relaciones duraderas con nuestros clientes.",
    ...
    "about.pillars.full": "Nuestros pilares fundamentales son la ética profesional, el compromiso con cada cliente y la búsqueda incesante de resultados. Creemos que la abogacía de excelencia se construye con transparencia, dedicación y conocimiento técnico profundo.",
  ...
  EN: {
    ...
    "about.trajectory.full": "With over two decades of experience in the legal market, Mota & Advogados Associados has built a solid trajectory based on consistent results and lasting relationships with our clients.",
    ...
    "about.pillars.full": "Our fundamental pillars are professional ethics, commitment to each client and the relentless pursuit of results. We believe that excellent legal practice is built with transparency, dedication and deep technical knowledge.",
  ...
  DE: {
    ...
    "about.trajectory.full": "Mit über zwei Jahrzehnten Erfahrung im Rechtsmarkt hat Mota & Advogados Associados einen soliden Werdegang aufgebaut.",
    ...
    "about.pillars.full": "Unsere grundlegenden Säulen sind berufliche Ethik, Engagement für jeden Kunden und das unermüdliche Streben nach Ergebnissen.",
  ...
  IT: {
    ...
    "about.trajectory.full": "Con oltre due decenni di esperienza nel mercato legale, Mota & Advogados Associados ha costruito una traiettoria solida.",
    ...
    "about.pillars.full": "I nostri pilastri fondamentali sono l'etica professionale, l'impegno verso ogni cliente e la ricerca incessante di risultati.",
  ...
  FR: {
    ...
    "about.trajectory.full": "Avec plus de deux décennies d'expérience sur le marché juridique, Mota & Advogados Associados a construit une trajectoire solide.",
    ...
    "about.pillars.full": "Nos piliers fondamentaux sont l'éthique professionnelle, l'engagement envers chaque client et la recherche incessante de résultats.",
    "about.mission.badge": "Excellence",
  ...
  ZH: {
    ...
    "about.trajectory.full": "在法律市场拥有超过二十年的经验，Mota & Advogados Associados建立了坚实的发展历程。",
    "about.pillars.badge": "道德 | 承诺",
    "about.pillars.title": "巩固的支柱",
    "about.pillars.description": "将道德、卓越和成果结合的法律实践支柱",
    "about.pillars.full": "我们的基本支柱是职业道德、对每位客户的承诺以及对结果的不懈追求。",
